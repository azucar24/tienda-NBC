$(document).ready(function() {
    ...
    $('#del-prod-form form').submit(function(e) {
         ...
         $.ajax({
            ...
            data:informacion,
            beforeSend: function(){
                $("#res-form-del-prod").html('<p>Eliminando producto </p>');
            },
            error: function() {
    ...
    $('#add-categori form').submit(function(e) {
         ...
         $.ajax({
            ...
            data:informacion,
            beforeSend: function(){
                $("#res-form-add-categori").html('Añadiendo categoria <br>');
            },
            error: function() {
    ...
    $('#del-categori form').submit(function(e) {
         ...
         $.ajax({
            ...
            data:informacion,
            beforeSend: function(){
                $("#res-form-del-cat").html('Eliminando categoria <br>');
            },
            error: function() {
    ...
    $('#add-provee form').submit(function(e) {
         ...
         $.ajax({
            ...
            data:informacion,
            beforeSend: function(){
                $("#res-form-add-prove").html('Agregando proveedor <br>');
            },
            error: function() {
    ...
    $('#del-prove form').submit(function(e) {
         ...
         $.ajax({
            ...
            data:informacion,
            beforeSend: function(){
                $("#res-form-del-prove").html('Eliminando proveedor <br>');
            },
            error: function() {
	...
	var myId = $(this).val();
        $('#update-category form#'+myId).submit(function(e) {
             ...
             $.ajax({
                ...
                data:informacion,
                beforeSend: function(){
                    $("div#"+myId).html('<br><br>Actualizando...');
                },
                error: function() {
    ...
    $('#add-admin form').submit(function(e) {
         ...
         $.ajax({
            ...
            data:informacion,
            beforeSend: function(){
                $("#res-form-add-admin").html('Agregando Administrador...<br>');
            },
            error: function() {
    ...
    $('#del-admin form').submit(function(e) {
         ...
         $.ajax({
            ...
            data:informacion,
            beforeSend: function(){
                $("#res-form-del-admin").html('Eliminando Administrador<br>');
            },
            error: function() {
    ...
    $('#del-pedido form').submit(function(e) {
         ...
         $.ajax({
            ...
            data:informacion,
            beforeSend: function(){
                $("#res-form-del-pedido").html('Eliminando Pedido...<br><');
            },
            error: function() {
